...
- Un **ancien puits** dans le quartier des yourtes constitue l’un des derniers accès connus vers ces souterrains.
- Les galeries sont partiellement **inondées selon les saisons**, rendant l’exploration dangereuse.
- Les anciens tribaux transmettent encore le souvenir de ces tombeaux et mettent en garde quiconque voudrait y descendre.
